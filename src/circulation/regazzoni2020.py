...
class Regazzoni2020(base.CirculationModel):
    ...
    def default_parameters() -> dict[str, Any]:
        return {
            ...
            "circulation": {
                "SYS": {
                    "R_AR": 0.733 * mmHg * s / mL,
                    "C_AR": 1.372 * mL / mmHg,
                    "R_VEN": 0.32 * mmHg * s / mL,
                    "C_VEN": 11.363 * mL / mmHg,
                    "L_AR": 0.005 * mmHg * s**2 / mL,
                    "L_VEN": 0.0005 * mmHg * s**2 / mL,
                },
                "PUL": {
                    "R_AR": 0.046 * mmHg * s / mL,
                    "C_AR": 20.0 * mL / mmHg,
                    "R_VEN": 0.0015 * mmHg * s / mL,
                    "C_VEN": 16.0 * mL / mmHg,
                    "L_AR": 0.0005 * mmHg * s**2 / mL,
                    "L_VEN": 0.0005 * mmHg * s**2 / mL,
                },
                "external": {
